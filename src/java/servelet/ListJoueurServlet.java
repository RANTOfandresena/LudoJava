 ...
 * @author RANTO
 */
public class ListJoueurServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String resultat="";
            for(JoueurModele uid : idJoueurs){
                String id1=uid.getId();
                resultat+=(id1+",");
            }
            out.print(resultat);
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ListJoueurServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
