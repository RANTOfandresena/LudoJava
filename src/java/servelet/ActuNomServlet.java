 ...
 * @author RANTO
 */
public class ActuNomServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print(listjoueur.toString());
            session1.setAttribute("listJ", listjoueur.toString());
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ActuNomServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
